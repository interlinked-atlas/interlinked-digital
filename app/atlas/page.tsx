            ...
            <div className="card-body">
              ...
              <div className="platforms">
                <div className="platform-badge">
                  {/* Apple logo */}
                  <svg width="16" height="16" viewBox="0 0 814 1000" fill="#8A8A96" xmlns="http://www.w3.org/2000/svg" style={{ overflow: 'visible' }}>
                    <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 411.3 0 331.1 0 254.2 0 113.3 90.6 39.5 178.9 39.5c66.8 0 109.6 43.8 148.4 43.8 36.9 0 95.8-46.9 168.7-46.9 26.5 0 108.2 2.6 168.1 80.1zm-130.3-73.7c0-37.7-15.4-77.7 0-139.1 12.9-51.5 51.4-94.9 75.3-94.9 3.8 12.6 3.8 25.2 3.8 37.7C737.4 149 698 207.3 657.8 267.2z"/>
                  </svg>
